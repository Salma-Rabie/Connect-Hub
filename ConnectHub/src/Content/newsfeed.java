...
public class newsfeed extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        JFrame frame = new JFrame("New Post");
        JPanel panel = new JPanel();
        frame.setVisible(true);
        frame.add(panel);
        panel.setBounds(100, 200, 300, 400);
        frame.setBounds(100, 200, 300, 400);
        ContentBuilder b = new ContentBuilder();
        b.setId("post123");
        b.setDate(new Date());
        b.setText("This is a sample post.");
        b.setImg(null); 
        
        posts post = new posts(b);
        System.out.println("date "+ b.build().getDate());
