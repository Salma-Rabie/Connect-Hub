            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(changePhoto, javax.swing.GroupLayout.DEFAULT_SIZE, 158, Short.MAX_VALUE)))
                .addGap(46, 46, 46)
    ...
    if(userName != null && !userName.equals("Users")){
        ...
        if (userId != null) {
            ...
            if(updatedGroup != null) {
                ...
                JOptionPane.showMessageDialog(this, userName + " has been deomote from admin.");
            } else {
                JOptionPane.showMessageDialog(this, "Failed to deomote " + userName + " from admin.", "Demotion Error", JOptionPane.ERROR_MESSAGE);
            }
        } 
    }
    ...
    if(userName != null && !userName.equals("All Users")){
        ...
        if (userId != null) {
            ...
            if(updatedGroup != null) {
                ...
                JOptionPane.showMessageDialog(this, "Failed to remove " + userName  , "Remove Error", JOptionPane.ERROR_MESSAGE);
            }
        } 
    }
